...
/**
 * Sistema de tipografía para la aplicación AsistenciaApp.
 * 
 ...
 * - Headline: Para títulos de secciones importantes
 * - Title: Para títulos de tarjetas y componentes
 * - Body: Para texto de contenido principal
 * - Label: Para etiquetas y texto pequeño
 */
val Typography = Typography(
    // Display styles - Para títulos muy grandes (pantallas principales)
