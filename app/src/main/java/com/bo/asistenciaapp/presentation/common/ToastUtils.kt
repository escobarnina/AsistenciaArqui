...
object ToastUtils {
     ...
     * 
     * Nota: En Android 11+ (API 30+), setGravity() no funciona para Toast de texto simple.
     * Se usa el comportamiento estándar en esas versiones.
     * 
    ...
    fun mostrarSuperior(context: Context, mensaje: String, duracion: Int = Toast.LENGTH_LONG) {
        ...
        // setGravity() solo funciona en versiones anteriores a Android 11 (API 30)
